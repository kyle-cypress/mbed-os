...
qspi_status_t QSPIFBlockDevice::_qspi_send_program_command(qspi_inst_t prog_inst, const void *buffer, bd_addr_t addr,
                                                           bd_size_t *size)
{
...
qspi_status_t QSPIFBlockDevice::_qspi_send_erase_command(qspi_inst_t erase_inst, bd_addr_t addr, bd_size_t size)
{
    ...
    status = _qspi.command_transfer(erase_inst, (int) addr, NULL, 0, NULL, 0); // Do not transmit or receive
